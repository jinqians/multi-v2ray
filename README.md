...
## 安装命令
```
source <(https://raw.githubusercontent.com/jinqians/multi-v2ray/refs/heads/master/v2ray.sh) --zh
```

## 升级命令(保留配置文件更新)
```
source <(https://raw.githubusercontent.com/jinqians/multi-v2ray/refs/heads/master/v2ray.sh) -k
```

## 卸载命令
```
source <(https://raw.githubusercontent.com/jinqians/multi-v2ray/refs/heads/master/v2ray.sh) --remove
```
